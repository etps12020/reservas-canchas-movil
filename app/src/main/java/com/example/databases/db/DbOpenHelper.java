...
public class DbOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        dmlDb.crearEstadoEdificioDeafult(db);
        dmlDb.crearEdificioDefault(db);
        dmlDb.crearEstadoCanchaDeafult(db);
        dmlDb.crearTipoCanchaDeafult(db);
        dmlDb.crearCanchaDefault(db);
    }
